...
public abstract class GZIPUtil {
    ...
    public static void main(String[] args) throws Exception {
    	String path = "C:\\test\\yan.txt";
    	String path2 = "C:\\test\\yan.gz";
//    	GZIPUtil.compress(path);
    	GZIPUtil.compress(path,path2);
    	

//    	String oldname = "C:\\test\\yan.txt.gz";
    	//GZIPUtil.decompress(path2, path);
	}
